        ...
        <div class="filter">
            <div class="form-set">
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label>交易方式</label>
                    <XzSelect v-model="filterType" :options="typeSelectOptions" class="o-select"></XzSelect>
                </div>
                 <div class="form-group">
                    <label>交易状态</label>
                    <XzSelect v-model="jyType" :options="statusSelectOptions" class="o-select"></XzSelect>
                </div>
            </div>
            <div class="form-set">
                <div class="form-group">
